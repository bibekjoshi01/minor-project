...
KiCad EDA was used for designing the schematic and PCB layouts of the system. It allowed precise placement of components, custom routing of power and signal lines, and integration of the slip-ring connections. KiCad’s 3D visualization tools were also employed to verify mechanical clearance and ensure proper alignment between the rotating and stationary sections.
