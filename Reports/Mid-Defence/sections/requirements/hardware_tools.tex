...
\end{itemize}
These characteristics are ideal for RSSI-driven control and reinforcement learning, as they produce predictable signal gradients and reduce learning instability. The antenna's low mass ($\\approx$19--40~g) allows reliable mounting on small stepper actuators with minimal mechanical inertia.
