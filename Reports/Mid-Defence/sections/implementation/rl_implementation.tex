...
This section describes the practical implementation of the Q-Learning based antenna alignment system. The focus is on system integration, data structures, and execution flow.
...
\begin{itemize}
    ...
    \item Reduces computational and memory overhead on the ESP32-S3
\end{itemize}
...
\begin{figure}[H]
    \vspace{1em} 
    \centering
    \includegraphics[width=1\textwidth]{images/rl_control_flow.png}
