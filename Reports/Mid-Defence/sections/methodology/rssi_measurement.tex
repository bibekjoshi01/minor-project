...
For debugging, performance evaluation, or offline analysis, RSSI measurements along with corresponding timestamps and antenna orientations can be logged temporarily on the MCU or transmitted to a host system. This facilitates visualization of signal trends and aids in parameter tuning for the RL agent.