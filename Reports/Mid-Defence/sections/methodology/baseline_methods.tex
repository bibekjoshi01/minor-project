...
The RSSI-based hill-climbing algorithm employs a local greedy optimization strategy. Starting from an initial antenna orientation, incremental adjustments are applied along the pan and tilt axes. If a perturbation results in an increase in RSSI, the new orientation is retained; otherwise, the system reverts or explores an alternative direction.
