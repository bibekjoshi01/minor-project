...
Wireless communication has evolved significantly since the pioneering experiments of Marconi in the early 1900s, becoming a fundamental component of modern communication systems~\cite{ref1}. 
Advancements in wireless networks have been driven by the increasing demand for mobility, higher data rates, and efficient spectrum utilization~\cite{ref7}. 
Antennas remain one of the most critical components influencing communication range, throughput, and interference characteristics~\cite{ref2}. 
...
In contrast, directional antennas concentrate energy in specific directions, offering higher gain, extended range, reduced interference, and improved energy efficiency~\cite{ref2,ref8}. 
...
Traditional antenna alignment relies on GPS-based coordinate tracking methods or signal tracking control methods (TCM)~\cite{ref3,ref6}. 
Other control-theoretic methods include imitation human intelligence control approaches, which attempt to mimic expert decision-making for antenna tracking~\cite{ref4}. 
Servo tracking systems have also been designed to enable precise mechanical alignment of vehicle-mounted antennas, demonstrating early practical implementations of automated antenna control~\cite{ref5}. 
...
RSSI-based alignment allows the antenna to adjust orientation to maximize signal strength without explicit knowledge of node positions~\cite{ref11,ref13}.
...
While simple, such methods are inefficient and unsuitable for real-time systems due to high latency and energy consumption~\cite{ref11,ref13}. 
More advanced methods incorporate estimation and control techniques including Kalman filters, unscented Kalman filters, and fuzzy logic controllers, often fusing RSSI with partial GPS data~\cite{ref14}. 
Autonomous antenna systems capable of self-orientation have also been explored to enhance wireless range and signal quality without human intervention~\cite{ref16}. 
...
Supervised learning approaches using MLP, CNN, and LSTM architectures have been shown to achieve high accuracy in predicting antenna alignment from S-parameter measurements~\cite{ref10}. 
Also, studies have surveyed AI-based beamforming and management techniques for 5G and 6G systems, highlighting the potential of learning-based approaches for optimizing antenna orientation and beam alignment~\cite{ref9}. 
...
RL-based approaches have been applied to antenna orientation, channel selection, beam selection, and power control~\cite{ref12,ref15}. 
Learning-based beam alignment methods for mmWave and 5G systems using DQN have demonstrated improved performance in highly dynamic environments~\cite{ref15}.

Multi-agent RL frameworks have also been investigated for antenna tilt optimization in cellular networks, enabling cooperative learning among neighbouring cells~\cite{ref12}. 
...
\textit{RSSI-Based Distributed Control to Align Directional Antenna Pairs for UAV Communication} (2024) \cite{ref11} \newline
Y. Wan et al.
&
...
\textit{Received Signal Strength Indicator-Based Decentralised Control for Robust Long-Range Aerial Networking Using Directional Antennas} (2017) \cite{ref14} \newline
Yan et al.
&
...
\textit{Self-Orientation of Directional Antennas Assisted by Mobile Robots} (2012) \cite{ref13} \newline
Min et al.
&
...
\textit{SmartAntenna: Enhancing Wireless Range with Autonomous Orientation} (2024) \cite{ref16} \newline
Swann et al.
&
...
\textit{Comparative Analysis of Machine Learning Algorithms for Antenna Alignments} (2024) \cite{ref10} \newline
Shakya et al.
&
...
\textit{Learning-Based Beam Alignment for Uplink mmWave UAVs} (2023) \cite{ref15} \newline
Susarla et al.
&
